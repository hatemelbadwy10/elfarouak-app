...
abstract class CustomersRepo{
  ...
  Future<Either<ApiFaliureModel, CustomerPartialUpadteModel>> getCustomerActivities({required int customerId, int page});
  Future<Either<ApiFaliureModel, String>> undoActivity({required int activityId});
  }