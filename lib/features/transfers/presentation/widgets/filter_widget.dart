          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String?>(
                ...
                items: const [
                  DropdownMenuItem(value: null, child: Text('اختر الحالة')), // Allow null value
              ...
              DropdownButtonFormField<String?>(
                ...
                items: const [
                  DropdownMenuItem(value: null, child: Text('اختر نوع التحويل')), // Allow null value
          ...
          TextButton(
            onPressed: () {
              final filterData = {
                ...
                'tag_id': customerId ?? '2', // Use customerId if selected, otherwise fallback
                'date_range':
                _dateRange != null ? '${_dateRange!.start.toIso8601String()} - ${_dateRange!.end.toIso8601String()}' : null,
              };

              // Dispatch the event
              context.read<TransferBloc>().add(GetTransfersEvent(
                status: _status,
                search: _searchController.text, // Pass the customer name
                transferType: _transferType,
                tagId: customerId, // Pass the customer ID
